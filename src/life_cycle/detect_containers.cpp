...
{
	//Open an image
	string path = ros::package::getPath("evolutive_map") + "/ressources/aerial_views/St_Nazaire_EXP.jpg";
	Mat image;
	...
	// 2m/long_container avec long_container = nb_pix_conteneurs_de_l'image*img_scale
